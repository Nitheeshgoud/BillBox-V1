      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-br from-indigo-50 via-white to-violet-50">
        <div className="mb-8">
          <a href="#" className="flex items-center space-x-2">
            <span className="text-3xl font-bold text-indigo-600">BillBox</span>
          </a>
        </div>
        ...
        >
          <div className="bg-white/60 backdrop-blur-lg p-8 sm:p-12 rounded-2xl color-black shadow-lg border border-gray-200/80">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  required
                  className="mt-1 block w-full px-4 py-3 bg-white border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
